...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default=r'D:\yolo\yolov7\runs\train\exp\weights\best.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='', help='model.yaml path')
    #parser.add_argument('--data', type=str, default='data/coco128.yaml', help='data.yaml path')
    parser.add_argument('--data', type=str, default='data/Insect.yaml', help='data.yaml path')
    ...
    # Evolve hyperparameters (optional)
        ...
        # torch.quantization.fuse_modules()  # torch里面内置的算子融合的api
